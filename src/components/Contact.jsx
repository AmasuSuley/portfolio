            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                  placeholder="amasusule@gmail.com"
                />
              </div>
              <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">ammarmassoud46@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Dar es salam, Tanzania</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">+255 657 004 727</p>
                  </div>
                </div>
              </div>
